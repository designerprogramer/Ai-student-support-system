...
export default function AffairsReminders() {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <DashboardHeader
        eyebrow="Student Affairs Dashboard"
        title="Reminders & Alerts"
        description="Stay on top of all unresolved student complaints, check response and resolution timers, and view system alerts."
      />
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 pb-5">
            <div>
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                ...
                Affairs Notification Feed
              </h2>
              <p className="text-xs text-gray-500 mt-0.5">Real-time alerts and assignments</p>
            </div>
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl border border-gray-100 p-6 shadow-sm flex flex-col">
          <div className="border-b border-gray-100 pb-5">
            <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
              ...
              General Complaint SLAs
            </h2>
            <p className="text-xs text-gray-500 mt-0.5">Track resolution status</p>
          </div>
          ...
          <div className="mt-5 space-y-4 max-h-[600px] overflow-y-auto pr-1">
            ...
            {complaints.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="mt-4 text-sm font-bold text-gray-900">No complaints</h3>
                <p className="mt-1 text-xs text-gray-500">There are no complaints in the system.</p>
              </div>
            ) : null}
          </div>
        </div>
